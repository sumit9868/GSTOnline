      ...
      <div className="info">
        ...
        <div className="info__header">
          ...
          <div className="box">
            ...
            <span className="question"> Q 1. What is Goods and Services Tax (GST)? <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 2. What exactly is the concept of destination based tax on consumption?<br /> </span>
...
<br/> <br/>
          ...
          <div className="box">
            ...
            <span className="question">Q 3. Which of the existing taxes are proposed to be subsumed under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> <br /> </span>
...
The GST Council shall make recommendations to the Union and States on the taxes, cesses and surcharges levied by the Centre, the States and the local bodies which may be subsumed in the GST. </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 4. What principles were adopted for subsuming the above taxes under GST?  <br /> </span>


            <span className="answer"> ns. The various Central, State and Local levies were examined to identify their possibility of being subsumed under GST. While identifying, the following principles were kept in mind: 
...
individually would need to be attempted. </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 5. Which are the commodities proposed to be kept outside the purview of GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 6. What type of GST is proposed to be implemented?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> QQ 7. Why is Dual GST required?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 8. Which authority will levy and administer GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 9. How a particular transaction of goods and services would be taxed simultaneously under Central GST (CGST) and State GST (SGST)?  <br /> </span>
...
paid on its purchase while for SGST he can utilise the credit of SGST alone. In other words, CGST credit cannot, in general, be used for payment of SGST. Nor can SGST credit be used for payment of CGST.     </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 10. What is IGST?  <br /> </span>
...
<br/> <br/>
          ...
          <div className="box">
            ...
            <span className="question">Q 11. Who is liable to pay GST under the proposed GST regime?  <br /> </span>
...
crossed the threshold limit. The CGST / SGST is payable on all intra-State supply of goods and/or services and IGST is payable on all inter- State supply of goods and/or services. The CGST /SGST and IGST are payable at the rates specified in the Schedules to the respective Acts.   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 12. What are the benefits available to small tax payers under the GST regime?  <br /> </span>
...
[Aggregate turnover shall include the aggregate value of all taxable supplies, exempt supplies and exports of goods and/or services and exclude taxes viz. GST.] Aggregate turnover shall be computed on all India basis. For NE States and special category states, the exemption threshold shall be [Rs. 10 lakhs]. All taxpayers eligible for threshold exemption will have the option of paying tax with input tax credit (ITC) benefits. Tax payers making inter-State supplies or paying tax on reverse charge basis shall not be eligible for threshold exemption.    </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 13. How will the goods and services be classified under GST regime?  <br /> </span>
...
Code (SAC)   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q14. How will imports be taxed under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 15. How will Exports be treated under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 16. What is the scope of composition scheme under GST?  <br /> </span>
...
Tax payers making inter- state supplies or making supplies through ecommerce operators who are required to collect tax at source shall not be eligible for composition scheme.  </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 17. Whether the composition scheme will be optional or compulsory?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 18. What is GSTN and its role in the GST regime?  <br /> </span>
...
The GSTN is developing a common GST portal and applications for registration, payment, return and MIS/ reports. The GSTN would also be integrating the common GST portal with the existing tax administration IT systems and would be building interfaces for tax payers. Further, the GSTN is developing back-end modules like assessment, audit, refund, appeal etc. for 19 States and UTs (Model II States). The CBEC and Model I States (15 States) are themselves developing their GST back-end systems. Integration of GST front-end system with back-end systems will have to be completed and tested well in advance for making the transition smooth.        </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 19. Whether actionable claims liable to GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 20. Is there any provision in GST for tax treatment of goods returned by the recipient?  <br /> </span>
...
output tax liability by the supplier that matches with the corresponding reduction in claim for ITC by the recipient shall be finally accepted and communicated to both parties.    </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 21. Where is the power to levy GST derived from?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 22. What is the taxable event under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 23. Whether supplies made without consideration will also come within the purview of supply under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 24. What are composite supply and mixed supply? How are these two different from each other? <br /> </span>
...
Mixed supply is combination of more than one individual supplies of goods or services or any combination thereof made in conjunction with each other for a single price, which can ordinarily be supplied separately. For example, a shopkeeper selling storage water bottles along with refrigerator. Bottles and the refrigerator can easily be priced and sold separately.       </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 25. What is the treatment of composite supply and mixed supply under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 26. Are all goods and services taxable under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 27. What is meant by Reverse Charge?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 28. Is the reverse charge mechanism applicable only to services?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">Q 29. What will be the implications in case of receipt of supply from unregistered persons?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 30. Can any person other than the supplier or recipient be liable to pay tax under GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 31. What is the threshold for opting to pay tax under the composition scheme?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 32. What are the rates of tax for composition scheme?  <br /> </span>
...
supplier, manufacturer and restaurant service respectively.   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 34. Will a taxable person, having multiple registrations, be eligible to opt for composition scheme only for a few of registrations?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 35. Can composition scheme be availed of by a manufacturer and a service supplier?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 36. Who are not eligible to opt for composition scheme?  <br /> </span>
...
(v) manufacturer of certain notified goods.   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 37. Can the registered person under composition scheme claim input tax credit?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 38. Can the customer who buys from a registered person who is under the composition scheme claim composition tax as input tax credit?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 39. Can composition tax be collected from customers?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 40. How to compute ‘aggregate turnover’ to determine eligibility for composition scheme?  <br /> </span>
...
under central tax (CGST), State tax (SGST), Union territory tax (UTGST), integrated tax(IGST) and compensation cess. Also, the value of inward supplies on which tax is payable under reverse charge is not taken into account for calculation of ‘aggregate turnover’. </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 41. What are the penal consequences if a person opts for the composition scheme in violation of the conditions?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 42. Does the GST Law empower the Government to exempt supplies from the levy of GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 43. What is advantage of taking registration in GST?  <br /> </span>
...
• Getting eligible to avail various other benefits and privileges rendered under the GST laws. <br />  </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 44. Can a person without GST registration claim ITC and collect tax?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 45. What will be the effective date of registration?  <br /> </span>
...
In case of a person taking registration voluntarily while being within the threshold exemption limit for paying tax, the effective date of registration shall be the date of order of registration.  </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 46. Who are the persons liable to take a Registration under the Model GST Law?  <br /> </span>
...
On the other hand, as per Section 23 of the Act, an agriculturist in respect of supply of his agricultural produce; as also any person exclusively making supply of non-taxable or wholly exempted goods and/or services under GST law will not be liable for registration.  </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 47. What is aggregate turnover?  <br /> </span>
...
The value of goods after completion of job work is not includible in the turnover of the job-worker. It will be treated as supply of goods by the principal and will accordingly be includible in the turnover of the Principal. </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 48. Which are the cases in which registration is compulsory?  <br /> </span>
...
xii) And such other person or class of persons as may be notified by the Central Government or a State Government on the recommendations of the Council.  </span>
          ...
          <div className="box">
            ...
            <span className="question">  Q 49. What is the time limit for taking a Registration under GST? <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 50. If a person is operating in different states, with the same PAN number, whether he can operate with a single Registration?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 51. Whether a person having multiple business verticals in a state can obtain for different registrations?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 52. Is there a provision for a person to get himself voluntarily registered though he may not be liable to pay GST?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 53. Is possession of a Permanent Account Number (PAN) mandatory for obtaining a Registration?  <br /> </span>
...
Also, as per Section 25(7) PAN is not mandatory for a non-resident taxable person who may be granted registration on the basis of any other document as maybe prescribed.   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 54. Whether the Registration granted to any person is permanent?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 55. Is it necessary for the Govt. Organization to get registration?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 56. Who is a Casual Taxable Person?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 57. Who is a Non-resident Taxable Person?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 58. Whether Amendments to the Registration Certificate is permissible?  <br /> </span>
...
It is to be noted that permission of the proper officer for making amendments will be required for only certain core fields of information, whereas for the other fields, the certificate of registration shall stand amended upon submission of application in the GST common portal.   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 59. At the time of registration will the assessee have to declare all his places of business?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 60. Is there any facility for digital signature in the GSTN registration?  <br /> </span>
          ...
          <div className="box">
            ...
            <span className="question">  Q 61. What will be the time limit for the decision on the on line registration application?  <br /> </span>
...
discrepancy in the application within such time, then the applicant will have to remove the discrepancy / deficiency within 7 days of such communication. Thereafter, for either approving the application or rejecting it, the State and the Central authorities will have 7 days from the date when the taxable person communicates removal of deficiencies. In case no response is given by the departmental authorities within the said time line, the portal shall automatically generate the registration.  </span>
          ...
          <div className="box">
            ...
            <span className="question">  Q 62. What will be the time of response by the applicant if any query is raised in the online application?  <br /> </span>
...
On receipt of additional document or clarification, the relevant tax authority will respond within seven common working days from the date of receipt of clarification </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 63. What is the process of refusal of registration?  <br /> </span>
...
of section 26 of the CGST Act, any rejection of application for registration by one authority (i.e. under the CGST Act / SGST Act) shall be deemed to be a rejection of application for registration by the other tax authority (i.e. under the SGST Act / UTGST Act/ CGST Act).   </span>
          ...
          <div className="box">
            ...
            <span className="question"> Q 64. Can the registration certificate be downloaded from the GSTN portal?  <br /> </span>
